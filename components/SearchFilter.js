import posts from "../pages/_posts";

const SearchFilter = ({ getStaticProps }) => {
  return (
        <div class="sticky top-0">
           
            <section  class="bg-gray-800 xl:w-72 xl:h-screen">
    <div class="flex justify-between px-4 py-3 xl:hidden">
      <div class="relative max-w-xs w-full">
        ...
        <div>
             <input {...getStaticProps } class="block w-full bg-gray-900 focus:outline-none focus:bg-white focus:text-gray-900 text-white rounded-lg pl-10 pr-4 py-2" placeholder="Search by keywords" onChange={(e)=>this.getStaticProps(e)} />
             </div>
    ...
    <form class="hidden xl:block xl:h-full xl:flex xl:flex-col xl:justify-between">
        ...
        <div class="px-4 py-4 border-t border-gray-900 lg:w-1/3 xl:border-t-0 xl:w-full">
          <div class="flex flex-wrap -mx-2">
            <label class="block w-1/2 px-2 sm:w-1/4 lg:w-1/2">
              <span class="text-sm font-semibold text-gray-500">Aantal x pw</span>
              <select class="mt-1 form-select block w-full text-white shadow focus:bg-gray-600">
                <option>4</option>
              </select>
            </label>
            <label class="block w-1/2 px-2 sm:w-1/4 lg:w-1/2">
              <span class="text-sm font-semibold text-gray-500">Uur pw</span>
              <select class="mt-1 form-select block w-full text-white shadow focus:bg-gray-600">
                <option>2</option>
              </select>
            </label>
            <label class="mt-4 block w-full px-2 sm:mt-0 sm:w-1/2 lg:mt-4 lg:w-full">
              <span class="text-sm font-semibold text-gray-500">Max per maand</span>
              <select class="mt-1 form-select block w-full text-white shadow focus:bg-gray-600">
                <option>Max €20,- /mnd</option>
              </select>
            </label>
          </div>
        </div>
        <div class="px-4 py-4 border-t border-gray-900 lg:w-1/3 lg:border-l xl:w-full">
          <span class="block text-sm font-semibold text-gray-500">Type sportschool</span>
          <div class="sm:flex sm:-mx-2 lg:block lg:mx-0">
            <label class="mt-3 sm:w-1/4 sm:px-2 flex items-center lg:w-full lg:px-0">
              ...
              <span class="ml-2 text-white">Basic</span>
            </label>
            <label class="mt-3 sm:w-1/4 sm:px-2 flex items-center lg:w-full lg:px-0">
            ...
            <label class="mt-3 sm:w-1/4 sm:px-2 flex items-center lg:w-full lg:px-0">
              ...
              <span class="ml-2 text-white">Luxury</span>
            </label>
            <label class="mt-3 sm:w-1/4 sm:px-2 flex items-center lg:w-full lg:px-0">
              <input class="form-radio bg-gray-900 focus:bg-gray-700" type="radio" name="propertyType" value="townhouse" />
              <span class="ml-2 text-white">Family</span>
            </label>
          </div>
        </div>
        <div class="px-4 py-4 border-t border-gray-900 lg:w-1/3 lg:border-l xl:w-full">
          <span class="block text-sm font-semibold text-gray-500">Voorzieningen</span>
          <div class="sm:flex sm:-mx-2 sm:flex-wrap">
            ...
            <label class="mt-3 flex items-center sm:w-1/2 sm:px-2 lg:w-full">
              ...
              <span class="ml-2 text-white">Cardio</span>
            </label>
          </div>
        </div>
      </div>
